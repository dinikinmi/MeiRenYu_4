...
public class FollowLvAdp extends BaseAdapter
{   Context context;
    ...
    public FollowLvAdp(Context context)
...
//		return MainActivity.recommend_arrayList.size();
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		{   itemBox=new ItemBox();
			...
			//because the layout structure of followLv_Item.xml and recommend_Lv_item.xml is indentical for each other,
			//so,the follow just find id of recommend_lv_item xml will be ok
		  ...
		  itemBox.triangleShapePic.setAlpha(30);
